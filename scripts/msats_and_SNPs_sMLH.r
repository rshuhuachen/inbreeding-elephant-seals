...
raw<-read.table("NES_notImp.raw",h=T) # Genotype data in plink raw format
out<-read.table("74_Samples_sMLH.txt",h=T) # This is the file where sMLH info will be saved (Empty 74 x 20 matrix with 
